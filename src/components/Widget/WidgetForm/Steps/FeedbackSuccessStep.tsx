...
export function FeedbackSucsessStep({
  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center py-10 w-[304px] font-sans'>
        <svg
          width='41'
          height='40'
          viewBox='0 0 41 40'
        ...
        <button
          ...
          className={`
            py-2 px-6 mt-6 text-white bg-indigo-500 rounded-md border-transparent
            text-sm leading-6 hover:bg-indigo-600 transition-colors
            focus:outline-none focus:ring-2 focus:ring-offset-2 
            focus:ring-offset-indigo-800 focus:ring-brand-500
          `}
        >
          Envie outro feedback
        </button>
      </div>
    </>
  );
